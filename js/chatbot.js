...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function addMessage(role, text) {
    ...
    avatar.textContent = role === "bot" ? "SKYVORA" : "You";
    if(role === "user") avatar.style.fontSize = "10px";
  ...
  function showTyping() {
    ...
    msg.innerHTML = `<div class="msg-avatar">SKYVORA</div><div class="msg-bubble"><div class="typing"><span></span><span></span><span></span></div></div>`;
    chatBody.appendChild(msg);
    chatBody.scrollTop = chatBody.scrollHeight;
  }
  function hideTyping() {
